...
Widening access to elite competitions can reinforce, rather than
erode, class barriers. We show this as the generic equilibrium
outcome once participation is treated as an endogenous,
income-constrained decision. A high-income incumbent competes against
low-income challengers in tournaments rewarding both innate ability
and acquired social capital, where the latter requires a threshold
expenditure. Exactly two stable Nash equilibria arise -- universal
and elite-only participation -- and a threshold
characterises which prevails. Wider income gaps simultaneously
strengthen the incumbent's investment incentive and price out
challengers, reconciling rising inequality with rising status
expenditure. The central finding is a hard mobility ceiling governed
by the weight placed on raw talent relative to social capital: no
reduction in participation costs, however large, can breach it
without a simultaneous change in what the competition rewards. 
...
$\mu r_i$ from social capital $(1-\mu)s_i$ --- the talent-weighted and social-capital-weighted components respectively ---
...
prediction that the class gap is increasing in $(1-\mu)$ (social capital weight):
finance and law are low-$\mu$ (talent weight) occupations
where networks and cultural fit dominate, while science and
engineering are high-$\mu$ (talent weight) occupations where technical output is
...
can overcome without also raising $\mu$ (talent weight). Reducing participation
...
a composite parameter embedding both $Q$ and $\mu$ (talent weight), and the ceiling
$\mu/[2(1-\mu)]$ is increasing in $\mu$ (talent weight). Policies that lower
$\overline{\nu}$ (credential subsidies, open-access qualifications,
reduced network barriers) shift the equilibrium toward universal
participation; policies that raise $\mu$, the talent weight (standardised assessment,
...
puzzle and the inclusive-participation (IP) over-investment result -- following from
...
$\Phi(1)$ is strictly decreasing in $\mu$ (talent weight): as social capital is
...
The comparative statics on $Q$ and $\mu$ (talent weight) generate a sharp distinction
...
$\mu<\tfrac{1}{2}$ and is increasing in $\mu$ (talent weight).
...
Third, $\overline{\nu}^*$ is decreasing in $\mu$ (talent weight): competitions
...
it identifies the structural parameter $\mu$ (talent weight) that would be
...
by $\mu$ (talent weight) alone: reducing $\overline{\nu}$ or expanding the pool of
challengers affects which equilibrium prevails but cannot raise the
ceiling itself. Raising $\mu$ (talent weight) through standardised, competency-based
...
to $1$; raising $\mu$ (talent weight) raises the ceiling continuously within either
...
terms, these competitions have low $Q$ and low $\mu$ (talent weight).
...
The Inclusive Participation (IP) trap exists because $\mu$ (talent weight) is low: social capital is so
decisive that low-income participants rationally over-invest in it
even when the high-income participant abstains. Raising $\mu$ (talent weight) ---
making raw talent more decisive relative to institutional affiliation
--- directly collapses the trap. Since $\Phi(Q)$ is strictly
decreasing in $\mu$ (talent weight), the feasibility window $U_1 < \Phi(Q) \leq
U_2/Q$ narrows as $\mu$ (talent weight) rises, and the anomalous equilibrium
disappears. Policy targeting small competitions should therefore
combine cost reduction with active raising of $\mu$ (talent weight): introducing
...
are necessary. Cost reduction alone --- without raising $\mu$ (talent weight) ---
...
at scale. Standardisation is typically designed to increase $\mu$ (talent weight)
...
Second, and working against this, raising $\mu$ (talent weight) through
...
structural advantage of the high-income participant. Raising $\mu$ (talent weight)
...
the investor. Two implications for education
...
The weight $\mu$ (talent weight) is a design parameter of the competition, not a
...
all correspond formally to an increase in $\mu$ (talent weight): they reduce the
...
equality of outcome and responds to $\mu$ (talent weight, the design side).
...
reduction reinforces elite-only equilibria --- is aligned with the Sutton Trust's finding that the Russell Group share of
disadvantaged students declined despite 25 years of widening
participation policy \citep{SuttonTrust2023}. It aligns also with China's
...
--- each map directly onto the model's $\mu$ (talent weight)--$(1-\mu)$ (social capital weight) architecture,
as set out there.
...
the ceiling formula $\mu/[2(1-\mu)]$ contains only $\mu$ (talent weight), so no
...
leaving $\mu$ (talent weight) and therefore the ceiling intact. The model
...
the $\mu$ (talent weight) prescription. In small competitions --- partner-track interviews,
...
over-investment trap is driven by low $\mu$ (talent weight), raising $\mu$ (talent weight) directly
collapses it: $\Phi(Q)$ is decreasing in $\mu$ (talent weight), so the feasibility
window for the anomalous equilibrium narrows as talent becomes more
decisive. Cost reduction alone --- without also raising $\mu$ (talent weight) ---
...
affiliation, and transparent assessment rubrics jointly raise $\mu$ (talent weight);
...
operative lever is raising $\mu$ (talent weight) through standardisation and
...
directly raises competitive rank -- situations that are even more likely to arise in growing economies. In positional contests, the
...
varies with $\mu$ (talent weight) but not with $Q$: cross-competition variation
