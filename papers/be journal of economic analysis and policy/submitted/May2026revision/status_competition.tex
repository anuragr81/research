...
expenditure in China \citep{JinLiWu2011} or data cross multiple countries
...
as follows. The two closest quantitative predecessors each reach conclusions that diverge from
...
The closest predecessor that the paper differs from is
...
inequality. The present paper diverges from \citet{GalliceGrillo2019} in two ways. First, the paper uses a mechanism where social capital enters the composite score directly as a productive rank-building input with effects on economic outcome - rather than as a signaling game. Second, the paper uses a threshold participation cost to arrive at binary equilibrium outcomes and implications for mobility ceiling. Whether inequality amplifies or dampens status investment conditional on universal participation is a distinct
question from whether inequality sustains or destroys participation itself.
