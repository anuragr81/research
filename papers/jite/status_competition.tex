...
\noindent\textbf{Keywords:} status competition; income inequality;
social capital; participation threshold; mobility ceiling

\medskip
\noindent\textbf{JEL Classification:} [e.g. D31, D62, J62, Z13]
...
This binary structure formalizes the intuition behind Hirsch's social limits to growth \cite{HirschSocialLimits} and provides
...
labor participation \cite{BenabouTiroleIntrinsicExtrinsic2003,FrankPond},
...
status does not directly contribute to utility but affects behavior
...
The three closest quantitative predecessors each address the question
of how inequality shapes status competition, but reach conclusions
that diverge from those of the present paper. \citeA{FrankAER1984}
...
inequality intensifies it. \citeA{ColeMailaithPostlewaite1992}
...
distribution save more \cite[p.~1103]{ColeMailaithPostlewaite1992}:
...
labor markets --- closes the range of costs that sustain universal
...
status hierarchies. Higher wage inequality in \citeA{FrankAER1984}
reduces competition intensity as it lowers the cost of low status.
In \citeA{ColeMailaithPostlewaite1992}, agents from an economy with
