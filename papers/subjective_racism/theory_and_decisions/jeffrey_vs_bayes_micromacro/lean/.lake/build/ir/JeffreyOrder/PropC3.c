...
// Module: JeffreyOrder.PropC3
// Imports: public import Init public meta import Init public import JeffreyOrder.PropC1
#include <lean/lean.h>
...
lean_object* initialize_Init(uint8_t builtin);
lean_object* initialize_jeffreyorder_JeffreyOrder_PropC1(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_jeffreyorder_JeffreyOrder_PropC3(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_jeffreyorder_JeffreyOrder_PropC1(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
