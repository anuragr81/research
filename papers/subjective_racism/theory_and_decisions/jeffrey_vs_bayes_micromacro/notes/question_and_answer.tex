...
experimental work that does elicit the association elicits it one conditional at
a time \citep{ZhaoOsherson2010}, never contrasting it between reading sequences.
The instrument the effect calls for is precisely that missing contrast: a
carrying statistic---a marginal, or the decision---compared between the two
sequences.
