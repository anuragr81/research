...
\paragraph{3. The attack has two prongs, and they are different in kind.}
Hawthorne's first prong is that the amnesia is implausible in itself: ``The
Amnestic Model treats the agent as subject to a strange sort of amnesia\dots
when I next see my car in dim light, its appearance at that moment completely
overwrites my beliefs regarding its true color. This seems highly implausible''
(p.~97). The second prong is about consequences: ``the order in which states or
experiences are acquired will almost always have a very significant influence on
an agent's belief strengths. This order effect is very troubling'' (p.~99), a note
pointing to \citet{DiaconisZabell1982} for how ubiquitous the effect is and to
\citet{Doring1999} for its implausibility (note~15).
The first prong is introspective and stays a matter of taste. The second is a
claim about effects in the world, and claims about effects are claims about what
