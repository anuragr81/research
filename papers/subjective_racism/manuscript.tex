...
that necessitates Jeffrey rather than Bayes.
...
by definition. Intuitively, $\sigma_{g_k}^2$ is an uncertainty
premium: even when the group mean is close to the agent's class,
...
the mobility parameter $\gamma$ above the bifurcation threshold $\gamma^*$ simultaneously eliminate allocative and
dynamic loss.
...
the product of the exclusion cost $\delta$ and the discrimination
rate $\phi$),
...
(bifurcation point) $\gamma^*$ and falls primarily on future generations of the
stigmatised group.
...
alter $\gamma$, $\sigma$, or $\delta$ but not the rigidity parameter $\rho$ (the weight
