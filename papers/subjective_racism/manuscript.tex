...
Outside option: $\bar{u}$. The utility depends on class distance
...
system. If a fraction $\phi^t$ of agents (the discrimination rate)
discriminate against group
$g$ in generation $t$, the group prior evolves as:
\begin{equation}
  \bar{c}_g^{t+1} =
