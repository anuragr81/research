...
The choice for workers in the economy is represented as an S-shaped utility function that in turn follows from an $N$-player formulation of competitions where workers use both social lottery and upskilling in a fixed socio-economic ladder (see Appendix for details). This stylised views considers two workers and a firm -- where workers choose a certain mixing criterion $\lambda$ to distribute income between fixed-lottery benefit $\Lambda$ and pay costs towards upskilling imposed by the firm. The lottery benefit $\Lambda$ is an exogenous benefit from social connections that is not managed by the firm. The firm thus adjusts either or both of the pay-distribution ($\alpha$) or the cost of training $b$ to maximise its profits.
