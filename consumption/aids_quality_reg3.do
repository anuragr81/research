...
global demand1 "(qnonfresh w_nonfresh  ln_tot_exp age hsize transport_assets_mtm household_assets_mtm electric_assets_mtm expensiveregion lpnonfresh lpdensefoods  lpcomplements  lpfruitsveg  lpprotein lpenergy lphousehold lptransport)"
global demand2 "(qVnonfresh lnV_nonfresh  ln_tot_exp age hsize transport_assets_mtm household_assets_mtm electric_assets_mtm expensiveregion lpnonfresh lpdensefoods  lpcomplements  lpfruitsveg  lpprotein lpenergy lphousehold lptransport)"
global demand3 "(qdensefoods w_densefoods  ln_tot_exp age hsize transport_assets_mtm household_assets_mtm electric_assets_mtm expensiveregion lpnonfresh lpdensefoods  lpcomplements  lpfruitsveg  lpprotein lpenergy lphousehold lptransport)"
global demand4 "(qVdensefoods lnV_densefoods  ln_tot_exp age hsize transport_assets_mtm household_assets_mtm electric_assets_mtm expensiveregion lpnonfresh lpdensefoods  lpcomplements  lpfruitsveg  lpprotein lpenergy lphousehold lptransport)"
global demand5 "(qcomplements w_complements  ln_tot_exp age hsize transport_assets_mtm household_assets_mtm electric_assets_mtm expensiveregion lpnonfresh lpdensefoods  lpcomplements  lpfruitsveg  lpprotein lpenergy lphousehold lptransport)"
global demand6 "(qVcomplements lnV_complements  ln_tot_exp age hsize transport_assets_mtm household_assets_mtm electric_assets_mtm expensiveregion lpnonfresh lpdensefoods  lpcomplements  lpfruitsveg  lpprotein lpenergy lphousehold lptransport)"
global demand7 "(qfruitsveg w_fruitsveg  ln_tot_exp age hsize transport_assets_mtm household_assets_mtm electric_assets_mtm expensiveregion lpnonfresh lpdensefoods  lpcomplements  lpfruitsveg  lpprotein lpenergy lphousehold lptransport)"
global demand8 "(qVfruitsveg lnV_fruitsveg  ln_tot_exp age hsize transport_assets_mtm household_assets_mtm electric_assets_mtm expensiveregion lpnonfresh lpdensefoods  lpcomplements  lpfruitsveg  lpprotein lpenergy lphousehold lptransport)"
global demand9 "(qprotein w_protein  ln_tot_exp age hsize transport_assets_mtm household_assets_mtm electric_assets_mtm expensiveregion lpnonfresh lpdensefoods  lpcomplements  lpfruitsveg  lpprotein lpenergy lphousehold lptransport)"
global demand10 "(qVprotein lnV_protein  ln_tot_exp age hsize transport_assets_mtm household_assets_mtm electric_assets_mtm expensiveregion lpnonfresh lpdensefoods  lpcomplements  lpfruitsveg  lpprotein lpenergy lphousehold lptransport)"
global demand11 "(qenergy w_energy  ln_tot_exp age hsize transport_assets_mtm household_assets_mtm electric_assets_mtm expensiveregion lpnonfresh lpdensefoods  lpcomplements  lpfruitsveg  lpprotein lpenergy lphousehold lptransport)"
global demand12 "(qhousehold w_household  ln_tot_exp age hsize transport_assets_mtm household_assets_mtm electric_assets_mtm expensiveregion lpnonfresh lpdensefoods  lpcomplements  lpfruitsveg  lpprotein lpenergy lphousehold lptransport)"
global demand13 "(qtransport w_transport  ln_tot_exp age hsize transport_assets_mtm household_assets_mtm electric_assets_mtm expensiveregion lpnonfresh lpdensefoods  lpcomplements  lpfruitsveg  lpprotein lpenergy lphousehold lptransport)"

global enlist "ln_tot_exp transport_assets_mtm household_assets_mtm electric_assets_mtm"
global exlist "occupation_rank educ_rank"
