...
use "C:\temp\df2010.dta", clear
*eststo, title (2010): quietly reg nu r i.max_occupation_rank i.max_education_rank
eststo, title (2010): quietly nl (nu  = {b0=.1}*(r^{b1=.5}))

use "C:\temp\df2012.dta", clear
*eststo, title (2012): quietly reg nu r i.max_occupation_rank i.max_education_rank
