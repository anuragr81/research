...
global edlogqne2012 (w_ne lnX r_educ log_mean_cost_ne i.agri max_education_rank father_educ_rank age rural_wards i.has_english hsize)
global edlogeduc2012 (w_educ lnX r_educ log_mean_cost_ne i.agri max_education_rank father_educ_rank age rural_wards i.has_english hsize)
eststo, title (Educ 2012): quietly sureg $edlogqne2012 $edlogeduc2012

global aglogqne2012 (w_ne lnX r_agri  log_mean_cost_ne i.agri max_education_rank father_educ_rank age rural_wards i.has_english hsize)
global aglogeduc2012 (w_educ lnX r_agri log_mean_cost_ne i.agri max_education_rank  father_educ_rank age rural_wards i.has_english hsize)
...
global edlogqne2014 (w_ne lnX r_educ  log_mean_cost_ne i.agri max_education_rank father_educ_rank age rural_wards i.has_english hsize)
global edlogeduc2014 (w_educ lnX r_educ log_mean_cost_ne i.agri max_education_rank  father_educ_rank age rural_wards i.has_english hsize)
eststo, title (Educ 2014): quietly sureg $edlogqne2014 $edlogeduc2014

global aglogqne2014 (w_ne lnX r_agri  log_mean_cost_ne i.agri max_education_rank father_educ_rank age rural_wards i.has_english hsize)
global aglogeduc2014 (w_educ lnX r_agri log_mean_cost_ne i.agri max_education_rank  father_educ_rank age rural_wards i.has_english hsize)
