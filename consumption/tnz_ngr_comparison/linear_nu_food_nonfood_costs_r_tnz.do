...
eststo, title (2012): quietly reg `depvar' logx log_mean_A0 log_mean_cost_ne_food log_mean_cost_ne_nonfood  i.max_occupation_rank i.max_education_rank age i.isrural hsize


use "C:\local_files\research\consumption\lsms\data\tn_df2014.dta", clear
eststo, title (2014): quietly reg `depvar' logx log_mean_A0 log_mean_cost_ne_food log_mean_cost_ne_nonfood  i.max_occupation_rank i.max_education_rank age hsize
