...
ds<-lsms_loader(fu=fu,ln=lsms_normalizer)@combined_data_set(year=2010,selected_category=lsms_normalizer()@food_categories_lsms_2010(), dirprefix='c:/local_files/research/consumption/')
