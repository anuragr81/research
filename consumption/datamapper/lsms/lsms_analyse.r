...
get_nonparametric_df <- function(ll,ln, food_analysis, use_ea, o2010, o2012, o2014, a2010, a2012, a2014, c2010, c2012, c2014 ){
  ...
  hsizes2010 <- ddply((ohs2010 %>% mutate(educprivate= schooltype=="private") )[,c("hhid","personid","educexpense","educprivate")],.(hhid),summarise,hsize=length(personid), toteducexpense=sum(educexpense[!is.na(educexpense)]),educpriv=choose_max_non_na(educprivate))
  ...
  hsizes2012 <- ddply((ohs2012 %>% mutate(educprivate= schooltype=="private") )[,c("hhid","personid","educexpense","educprivate")],.(hhid),summarise,hsize=length(personid), toteducexpense=sum(educexpense[!is.na(educexpense)]),educpriv=choose_max_non_na(educprivate))
  ...
  hsizes2014 <- ddply((ohs2014 %>% mutate(educprivate= schooltype=="private") )[,c("hhid","personid","educexpense","educprivate")],.(hhid),summarise,hsize=length(personid), toteducexpense=sum(educexpense[!is.na(educexpense)]),educpriv=choose_max_non_na(educprivate))
