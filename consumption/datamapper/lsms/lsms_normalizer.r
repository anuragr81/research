...
setClass("LSMSNormalizer", representation(hh_mapping_lsms_2008= "function",
                                          ...
                                          fao_food_diversity_score_HDDS="function",fao_food_quality_groups="function",
...
lsms_normalizer<-function() {
  ...
  fao_food_quality_groups<- function(){
    x<-NULL
    x<-rbind(x,data.frame(category='fat', group='quality', shortname='cooking_oil'))
    x<-rbind(x,data.frame(category='fat', group='quality', shortname='eggs'))
    
    x<-rbind(x,data.frame(category='meats-proteins', group='quality', shortname='beef'))
    x<-rbind(x,data.frame(category='meats-proteins', group='quality', shortname='goat'))
    x<-rbind(x,data.frame(category='meats-proteins', group='quality', shortname='pork'))
    x<-rbind(x,data.frame(category='meats-proteins', group='quality', shortname='pulses'))
    x<-rbind(x,data.frame(category='meats-proteins', group='quality', shortname='onion'))
    x<-rbind(x,data.frame(category='meats-proteins', group='quality', shortname='salt'))
    x<-rbind(x,data.frame(category='meats-proteins', group='quality', shortname='canned_milk'))
    x<-rbind(x,data.frame(category='meats-proteins', group='quality', shortname='wild_birds'))
    x<-rbind(x,data.frame(category='meats-proteins', group='quality', shortname='wild_meat'))
    ...
    x<-rbind(x,data.frame(category='veg', group='quality', shortname='greens'))
    x<-rbind(x,data.frame(category='veg', group='quality', shortname='othervegstarch'))
    
    x<-rbind(x,data.frame(category='milk', group='quality', shortname='milk_products'))
    x<-rbind(x,data.frame(category='milk', group='quality', shortname='fresh_milk'))
    
    
    x<-rbind(x,data.frame(category='starches', group='quality', shortname='millet_grain'))
    x<-rbind(x,data.frame(category='starches', group='quality', shortname='sugarcane'))
    x<-rbind(x,data.frame(category='starches', group='quality', shortname='rice_paddy'))
    x<-rbind(x,data.frame(category='starches', group='quality', shortname='potatoes'))
    x<-rbind(x,data.frame(category='starches', group='quality', shortname='canned_drink'))
    x<-rbind(x,data.frame(category='starches', group='quality', shortname='sweet_potato'))
    x<-rbind(x,data.frame(category='starches', group='quality', shortname='bread'))
    x<-rbind(x,data.frame(category='chicken', group='quality', shortname='chicken'))
    ...
    x<-rbind(x,data.frame(category='tubers', group='quality', shortname='yam'))
    x<-rbind(x,data.frame(category='tubers', group='quality', shortname='millet_flour'))
    x<-rbind(x,data.frame(category='tubers', group='quality', shortname='banana_green'))
    x<-rbind(x,data.frame(category='tubers', group='quality', shortname='cassava_flour'))
    
    
    x<-rbind(x,data.frame(category='fruits', group='quality', shortname='banana_ripe'))
    x<-rbind(x,data.frame(category='fruits', group='quality', shortname='cassava_fresh'))
    x<-rbind(x,data.frame(category='fruits', group='quality', shortname='peanuts'))
    x<-rbind(x,data.frame(category='fruits', group='quality', shortname='citrus'))
    x<-rbind(x,data.frame(category='fruits', group='quality', shortname='coconut'))
    x<-rbind(x,data.frame(category='fruits', group='quality', shortname='cashew_almonds'))
    x<-rbind(x,data.frame(category='fruits', group='quality', shortname='nut_products'))
    x<-rbind(x,data.frame(category='fruits', group='quality', shortname='mangoes'))
    x<-rbind(x,data.frame(category='fruits', group='quality', shortname='dried_canned_veg'))
  ...
  categories_needs_based <- function()  {
    ...
    #fat - 50g per day
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='rice_husked' , recq = .25, assetlevel="none"))
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='rice_paddy', recq = .25, assetlevel="none"))
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='maize_green', recq = .25, assetlevel="none"))
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='maize_grain', recq = .25, assetlevel="none"))
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='maize_flour', recq = .25, assetlevel="none"))
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='millet_grain', recq = .25, assetlevel="none"))
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='millet_flour', recq = .25, assetlevel="none"))
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='wheat', recq = .25, assetlevel="none"))
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='bread', recq = .20, assetlevel="none"))
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='bunscakes', recq = .20, assetlevel="none"))
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='pasta', recq = .20, assetlevel="none"))
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='othercereal', recq = .20, assetlevel="none"))
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='cassava_fresh', recq = .4, assetlevel="none"))
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='cassava_flour', recq = .25, assetlevel="none"))
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='sweet_potato', recq = .4, assetlevel="none"))
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='potatoes', recq = .4, assetlevel="none"))
    
    x<-rbind(x,data.frame(category='fat', group='needs', shortname='peanuts', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='fat', group='needs', shortname='coconut', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='fat', group='needs', shortname='cashew_almonds', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='fat', group='needs', shortname='nut_products', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='fat', group='needs', shortname='cooking_oil', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='fat', group='needs', shortname='butter_margarine', recq = .05, assetlevel="none"))
    
    x<-rbind(x,data.frame(category='protein', group='needs', shortname='pulses', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='protein', group='needs', shortname='milk_products', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='protein', group='needs', shortname='fresh_milk', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='protein', group='needs', shortname='canned_milk', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='protein', group='needs', shortname='goat', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='protein', group='needs', shortname='beef', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='protein', group='needs', shortname='pork', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='protein', group='needs', shortname='chicken', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='protein', group='needs', shortname='wild_birds', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='protein', group='needs', shortname='wild_meat', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='protein', group='needs', shortname='fish_seafood', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='protein', group='needs', shortname='dried_canned_fish', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='protein', group='needs', shortname='packaged_fish', recq = .05, assetlevel="none"))
    x<-rbind(x,data.frame(category='protein', group='needs', shortname='eggs', recq = .05, assetlevel="none"))
    ...
    x<-rbind(x,data.frame(category='fruitsveg', group='needs', shortname='onion', recq = .4, assetlevel="none"))
    x<-rbind(x,data.frame(category='fruitsveg', group='needs', shortname='greens', recq = .4, assetlevel="none"))
    x<-rbind(x,data.frame(category='fruitsveg', group='needs', shortname='dried_canned_veg', recq = .4, assetlevel="none"))
    x<-rbind(x,data.frame(category='fruitsveg', group='needs', shortname='yam', recq = .4, assetlevel="none"))
    x<-rbind(x,data.frame(category='fruitsveg', group='needs', shortname='banana_green', recq = .4, assetlevel="none"))
    x<-rbind(x,data.frame(category='fruitsveg', group='needs', shortname='othervegstarch', recq = .4, assetlevel="none"))
    x<-rbind(x,data.frame(category='fruitsveg', group='needs', shortname='banana_ripe', recq = .4, assetlevel="none"))
    x<-rbind(x,data.frame(category='fruitsveg', group='needs', shortname='citrus', recq = .4, assetlevel="none"))
  ...
  return(new("LSMSNormalizer",diary_info_columns_lsms_2008=diary_info_columns_lsms_2008,
             ...
             fao_food_diversity_score_HDDS=fao_food_diversity_score_HDDS,fao_food_quality_groups=fao_food_quality_groups,
