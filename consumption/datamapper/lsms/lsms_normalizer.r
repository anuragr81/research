...
lsms_normalizer<-function() {
  ...
  fao_food_quality_groups<- function(){
    ...
    x<-rbind(x,data.frame(category='meatsproteins', group='quality', shortname='beef'))
    x<-rbind(x,data.frame(category='meatsproteins', group='quality', shortname='goat'))
    x<-rbind(x,data.frame(category='meatsproteins', group='quality', shortname='pork'))
    x<-rbind(x,data.frame(category='meatsproteins', group='quality', shortname='pulses'))
    x<-rbind(x,data.frame(category='meatsproteins', group='quality', shortname='onion'))
    x<-rbind(x,data.frame(category='meatsproteins', group='quality', shortname='salt'))
    x<-rbind(x,data.frame(category='meatsproteins', group='quality', shortname='canned_milk'))
    x<-rbind(x,data.frame(category='meatsproteins', group='quality', shortname='wild_birds'))
    x<-rbind(x,data.frame(category='meatsproteins', group='quality', shortname='wild_meat'))
