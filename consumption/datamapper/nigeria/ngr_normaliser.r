...
ngr_normaliser<-function() {
  ...
  expenditure_categories <- function(include_food)  {
    ...
    r <- rbind(r,data.frame(shortname='corn', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='millet', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='maize_grain', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='rice_local', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='rice_imported', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='bread', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='maize_flour', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='yam_flour', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='cassava_flour', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='wheat_flour', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='other_grains', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='cassava_fresh', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='yam_fresh', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='gari_white', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='gari_yellow', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='cocoyam', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='plantains', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='sweet_potato', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='potato', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='roots_other', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='soyabeans', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='brown_beans', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='white_beans', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='peanuts', category='fat', group=''))
    r <- rbind(r,data.frame(shortname='nuts_others', category='fat', group=''))
    r <- rbind(r,data.frame(shortname='palm_oil', category='fat', group=''))
    r <- rbind(r,data.frame(shortname='butter_margarine', category='fat', group=''))
    r <- rbind(r,data.frame(shortname='peanut_oil', category='fat', group=''))
    r <- rbind(r,data.frame(shortname='oil_others', category='fat', group=''))
    r <- rbind(r,data.frame(shortname='bananas', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='citrus', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='mangoes', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='avocado_pear', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='pineapples', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='fruit_canned', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='other_fruits', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='tomatoes', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='tomatoes_puree', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='onions', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='eggplant', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='okra_fresh', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='okra_dried', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='pepper', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='fresh_leaves', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='vegetables_others', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='chicken', category='', group='fruitsveg'))
    r <- rbind(r,data.frame(shortname='duck', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='poultry_others', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='eggs_garden', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='eggs_agri', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='eggs_local', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='eggs_others', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='beef', category='', group=''))
    r <- rbind(r,data.frame(shortname='mutton', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='pork', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='goat', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='game', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='beef_corned', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='meat_others', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='fresh_fish', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='frozen_fish', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='smoked_fish', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='dried_fish', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='snails', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='seafoods', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='canned_seafood', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='fish_others', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='fresh_milk', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='milk_powder', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='babymilk', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='canned_milk', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='milk_others', category='protein', group=''))
    r <- rbind(r,data.frame(shortname='coffee', category='beverages', group=''))
    r <- rbind(r,data.frame(shortname='choco_drinks', category='beverages', group=''))
    r <- rbind(r,data.frame(shortname='tea', category='beverages', group=''))
    r <- rbind(r,data.frame(shortname='sugar', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='jams', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='honey', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='sweets_others', category='carbs', group=''))
    r <- rbind(r,data.frame(shortname='condiments', category='fruitsveg', group=''))
    r <- rbind(r,data.frame(shortname='water_bottled', category='beverages', group=''))
    r <- rbind(r,data.frame(shortname='water_sachet', category='beverages', group=''))
    r <- rbind(r,data.frame(shortname='malt_drinks', category='beverages', group=''))
    r <- rbind(r,data.frame(shortname='soft_drinks', category='beverages', group=''))
    r <- rbind(r,data.frame(shortname='peanut_pack', category='fat', group=''))
    r <- rbind(r,data.frame(shortname='soft_drinks_others', category='beverages', group=''))
    r <- rbind(r,data.frame(shortname='local_beer', category='beverages', group=''))
    r <- rbind(r,data.frame(shortname='palm_wine', category='beverages', group=''))
    r <- rbind(r,data.frame(shortname='pito', category='beverages', group=''))
    r <- rbind(r,data.frame(shortname='gin', category='beverages', group=''))
    r <- rbind(r,data.frame(shortname='alcoholic_others', category='beverages', group=''))
    r <- rbind(r,data.frame(shortname='cigarettes', category='general', group=''))
    r <- rbind(r,data.frame(shortname='matches', category='general', group=''))
    r <- rbind(r,data.frame(shortname='newspapers', category='general', group=''))
    r <- rbind(r,data.frame(shortname='public_transport', category='general', group=''))
    r <- rbind(r,data.frame(shortname='kerosene', category='general', group=''))
    r <- rbind(r,data.frame(shortname='palm_kernel_oil', category='general', group=''))
    r <- rbind(r,data.frame(shortname='gas', category='general', group=''))
    r <- rbind(r,data.frame(shortname='liquid_fuel', category='general', group=''))
    r <- rbind(r,data.frame(shortname='electricity', category='general', group=''))
    r <- rbind(r,data.frame(shortname='candle', category='general', group=''))
    r <- rbind(r,data.frame(shortname='firewood', category='general', group=''))
    r <- rbind(r,data.frame(shortname='charcoal', category='general', group=''))
    r <- rbind(r,data.frame(shortname='petrol', category='general', group=''))
    r <- rbind(r,data.frame(shortname='diesel', category='general', group=''))
    r <- rbind(r,data.frame(shortname='electric_bulb', category='general', group=''))
    r <- rbind(r,data.frame(shortname='water', category='general', group=''))
    r <- rbind(r,data.frame(shortname='soap', category='general', group=''))
    r <- rbind(r,data.frame(shortname='toilet_paper', category='general', group=''))
    r <- rbind(r,data.frame(shortname='cosmetics', category='general', group=''))
    r <- rbind(r,data.frame(shortname='vitamin', category='general', group=''))
    r <- rbind(r,data.frame(shortname='insecticides', category='general', group=''))
    r <- rbind(r,data.frame(shortname='fresh_postal', category='general', group=''))
    r <- rbind(r,data.frame(shortname='phone_recharge', category='general', group=''))
    r <- rbind(r,data.frame(shortname='landline_charge', category='general', group=''))
    r <- rbind(r,data.frame(shortname='internet', category='general', group=''))
    r <- rbind(r,data.frame(shortname='cinema_dvd', category='general', group=''))
    r <- rbind(r,data.frame(shortname='motor_repair', category='general', group=''))
    r <- rbind(r,data.frame(shortname='bicycle_repair', category='general', group=''))
    r <- rbind(r,data.frame(shortname='wages', category='general', group=''))
    r <- rbind(r,data.frame(shortname='mortgage', category='general', group=''))
    r <- rbind(r,data.frame(shortname='maintenance_house', category='general', group=''))
    r <- rbind(r,data.frame(shortname='maintenance_household', category='general', group=''))
    r <- rbind(r,data.frame(shortname='house_rent', category='general', group=''))
    r <- rbind(r,data.frame(shortname='other_monthly', category='general', group=''))
    r <- rbind(r,data.frame(shortname='clothes_infant', category='general', group=''))
    r <- rbind(r,data.frame(shortname='clothes_baby', category='general', group=''))
    r <- rbind(r,data.frame(shortname='clothes_boys_tailored', category='general', group=''))
    r <- rbind(r,data.frame(shortname='clothes_boys_made', category='general', group=''))
    r <- rbind(r,data.frame(shortname='clothes_girls_tailored', category='general', group=''))
    r <- rbind(r,data.frame(shortname='clothes_girls_made', category='general', group=''))
    r <- rbind(r,data.frame(shortname='clothes_men_tailored', category='general', group=''))
    r <- rbind(r,data.frame(shortname='clothes_men_made', category='general', group=''))
    r <- rbind(r,data.frame(shortname='women_clothes_tailored', category='general', group=''))
    r <- rbind(r,data.frame(shortname='women_clothes_made', category='general', group=''))
    r <- rbind(r,data.frame(shortname='ankara_george_clothes', category='general', group=''))
    r <- rbind(r,data.frame(shortname='clothes_others', category='general', group=''))
    r <- rbind(r,data.frame(shortname='shoes_boys', category='general', group=''))
    r <- rbind(r,data.frame(shortname='shoes_men', category='general', group=''))
    r <- rbind(r,data.frame(shortname='shoes_girls', category='general', group=''))
    r <- rbind(r,data.frame(shortname='shoes_women', category='general', group=''))
    r <- rbind(r,data.frame(shortname='tailoring_charge', category='general', group=''))
    r <- rbind(r,data.frame(shortname='laundry_charge', category='general', group=''))
    r <- rbind(r,data.frame(shortname='bowls', category='general', group=''))
    r <- rbind(r,data.frame(shortname='cooking_utensils', category='general', group=''))
    r <- rbind(r,data.frame(shortname='cleaning_utensils', category='general', group=''))
    r <- rbind(r,data.frame(shortname='torch', category='general', group=''))
    r <- rbind(r,data.frame(shortname='rainwear', category='general', group=''))
    r <- rbind(r,data.frame(shortname='lamp', category='general', group=''))
    r <- rbind(r,data.frame(shortname='stationery_notschool', category='general', group=''))
    r <- rbind(r,data.frame(shortname='books_notschool', category='general', group=''))
    r <- rbind(r,data.frame(shortname='house_decorations', category='general', group=''))
    r <- rbind(r,data.frame(shortname='lodging_charges', category='general', group=''))
    r <- rbind(r,data.frame(shortname='donations', category='general', group=''))
    r <- rbind(r,data.frame(shortname='health_expenditure', category='general', group=''))
    r <- rbind(r,data.frame(shortname='clothing_materials', category='general', group=''))
    r <- rbind(r,data.frame(shortname='footwear_repairs', category='general', group=''))
    r <- rbind(r,data.frame(shortname='electric_kettle', category='general', group=''))
    r <- rbind(r,data.frame(shortname='nonelectric_pot', category='general', group=''))
    r <- rbind(r,data.frame(shortname='appliance_repairs', category='general', group=''))
    r <- rbind(r,data.frame(shortname='bed_sheets', category='general', group=''))
    r <- rbind(r,data.frame(shortname='pillows', category='general', group=''))
    r <- rbind(r,data.frame(shortname='linen', category='general', group=''))
    r <- rbind(r,data.frame(shortname='carpets', category='general', group=''))
    r <- rbind(r,data.frame(shortname='cellphone', category='general', group=''))
    r <- rbind(r,data.frame(shortname='lodging', category='general', group=''))
    r <- rbind(r,data.frame(shortname='carpets_rugs', category='general', group=''))
    r <- rbind(r,data.frame(shortname='linen', category='general', group=''))
    r <- rbind(r,data.frame(shortname='mat', category='general', group=''))
    r <- rbind(r,data.frame(shortname='mosquito_net', category='general', group=''))
    r <- rbind(r,data.frame(shortname='mattress', category='general', group=''))
    r <- rbind(r,data.frame(shortname='sports_hobby', category='general', group=''))
    r <- rbind(r,data.frame(shortname='films', category='general', group=''))
    r <- rbind(r,data.frame(shortname='building_material', category='general', group=''))
    r <- rbind(r,data.frame(shortname='council_rates', category='general', group=''))
    r <- rbind(r,data.frame(shortname='health_insurance', category='general', group=''))
    r <- rbind(r,data.frame(shortname='auto_insurance', category='general', group=''))
    r <- rbind(r,data.frame(shortname='home_insurance', category='general', group=''))
    r <- rbind(r,data.frame(shortname='life_insurance', category='general', group=''))
    r <- rbind(r,data.frame(shortname='fines', category='general', group=''))
    r <- rbind(r,data.frame(shortname='dowry', category='general', group=''))
    r <- rbind(r,data.frame(shortname='marriage_ceremony_costs', category='general', group=''))
    r <- rbind(r,data.frame(shortname='funeral_costs', category='general', group=''))
    r <- rbind(r,data.frame(shortname='woodpoles_bamboo', category='general', group=''))
    r <- rbind(r,data.frame(shortname='grass', category='general', group=''))
    
    
    x<-rbind(x,data.frame(category='carbs', group='needs', shortname='rice_husked' ))
    x<-rbind(x,data.frame(category='fat', group='needs', shortname='peanuts'))
    x<-rbind(x,data.frame(category='protein', group='needs', shortname='pulses'))
    x<-rbind(x,data.frame(category='fruitsveg', group='needs', shortname='onion'))
    
    x<-rbind(x,data.frame(category='general', group='excess', shortname='cigarettes'))
    x<-rbind(x,data.frame(category='general', group='asset_costs', shortname='matches'))
    return(x)
