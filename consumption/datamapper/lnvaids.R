...
run_agg_data <- function (dat) {
  ...
  #total_expenditure, nonfresh_tot_categ_exp, densefoods_tot_categ_exp, 
  #energy_tot_categ_exp, 
  #nonfresh_min_price, densefoods_min_price, energy_min_price, 
  #nonfresh_quality, densefoods_quality, consu, age, expensiveregion, popdensity, 
  #occupation_rank, , ln_tot_exp, w_densefoods, w_nonfresh, w_energy, educ_rank, 
  #lpnonfresh, lpdensefoods, lpenergy, 
  #lnV_nonfresh, lnV_densefoods, lnV_energy, 
