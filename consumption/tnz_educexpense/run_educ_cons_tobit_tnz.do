...
eststo tnz_weduc_r , title (HH): quietly tobit w_educ logx r2012 log_mean_cost_ne i.agri i.educpriv   i.father_educ_rank secondary_schools i.is_primaryage i.is_secondaryage i.is_tertiaryage  i.has_english numchild, ll(0) 
...
eststo tnz_weduc_r_i , title (INDIV): quietly tobit w_educ logx r2012 log_mean_cost_ne i.agri i.educpriv  i.father_educ_rank secondary_schools i.current_educ_rank i.has_english numchild, ll(0) 
...
eststo tnz_logeduc_r, title (HH): quietly tobit log_educ logx r2012 log_mean_cost_ne i.agri i.educpriv    i.father_educ_rank secondary_schools i.is_primaryage i.is_secondaryage i.is_tertiaryage  i.has_english numchild, ll(0) 
...
eststo tnz_logeduc_r_i, title (INDIV): quietly tobit log_educ logx r2012 log_mean_cost_ne i.agri i.educpriv    i.father_educ_rank secondary_schools i.current_educ_rank  i.has_english numchild, ll(0) 
...
eststo tnz_weduc_urbanrural, title (HH): quietly tobit w_educ lnA0 log_mean_cost_ne i.agri i.educpriv   i.father_educ_rank secondary_schools i.is_primaryage i.is_secondaryage i.is_tertiaryage rural_wards i.has_english numchild, ll(0)
...
eststo tnz_weduc_urbanrural_i, title (INDIV): quietly tobit w_educ lnA0 log_mean_cost_ne i.agri i.educpriv   i.father_educ_rank secondary_schools i.current_educ_rank rural_wards i.has_english numchild, ll(0)
