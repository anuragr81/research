...
eststo tnz_logeduc_urbanrural, title (HH): quietly tobit log_educ lnA0 log_mean_cost_ne i.agri i.educpriv i.father_educ_rank secondary_schools i.is_primaryage i.is_secondaryage i.is_tertiaryage rural_wards i.has_english numchild, ll(0)
...
eststo tnz_logeduc_urbanrural_i, title (INDIV): quietly tobit log_educ lnA0 log_mean_cost_ne i.agri i.educpriv i.father_educ_rank secondary_schools i.current_educ_rank rural_wards i.has_english numchild, ll(0)
...
eststo tnz_weduc_reduc, title (Educ HH): quietly tobit w_educ logx r_educ2012 log_mean_cost_ne i.agri i.educpriv i.father_educ_rank secondary_schools i.is_primaryage i.is_secondaryage i.is_tertiaryage  i.has_english numchild, ll(0)

use "C:\local_files\research\consumption\lsms\data\tn_i_df2014.dta", clear
drop if numchild == 0

eststo tnz_weduc_reduc_i, title (Educ INDIV): quietly tobit w_educ logx r_educ2012 log_mean_cost_ne i.agri i.educpriv i.father_educ_rank secondary_schools i.current_educ_rank  i.has_english numchild, ll(0)
...
eststo tnz_logeduc_reduc, title (Educ HH): quietly tobit log_educ logx r_educ2012  log_mean_cost_ne i.agri i.educpriv  i.father_educ_rank secondary_schools i.is_primaryage i.is_secondaryage i.is_tertiaryage  i.has_english numchild, ll(0)

use "C:\local_files\research\consumption\lsms\data\tn_i_df2014.dta", clear
drop if numchild == 0
gen log_educ= log(toteducexpense+1e-7)

eststo tnz_logeduc_reduc_i, title (Educ INDIV): quietly tobit log_educ logx r_educ2012  log_mean_cost_ne i.agri i.educpriv  i.father_educ_rank secondary_schools i.current_educ_rank  i.has_english numchild, ll(0)
...
eststo tnz_weduc_roccup, title (Agri HH): quietly tobit w_educ logx r_agri2012 log_mean_cost_ne i.educpriv  i.father_educ_rank secondary_schools i.is_primaryage i.is_secondaryage i.is_tertiaryage  i.has_english numchild, ll(0)


use "C:\local_files\research\consumption\lsms\data\tn_i_df2014.dta", clear
drop if numchild == 0
eststo tnz_weduc_roccup_i, title (Agri INDIV): quietly tobit w_educ logx r_agri2012 log_mean_cost_ne i.educpriv  i.father_educ_rank secondary_schools i.current_educ_rank  i.has_english numchild, ll(0)
...
eststo tnz_logeduc_roccup, title (Agri HH): quietly tobit log_educ logx r_agri2012 log_mean_cost_ne i.educpriv  i.father_educ_rank secondary_schools i.is_primaryage i.is_secondaryage i.is_tertiaryage  i.has_english numchild, ll(0)
...
eststo tnz_logeduc_roccup_i, title (Agri INDIV): quietly tobit log_educ logx r_agri2012 log_mean_cost_ne i.educpriv  i.father_educ_rank secondary_schools i.current_educ_rank  i.has_english numchild, ll(0)
