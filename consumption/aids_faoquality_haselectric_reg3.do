...
global demand3 "(qmeatsproteins: w_meatsproteins  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand4 "(qVmeatsproteins: lnV_meatsproteins  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand5 "(qcereals: w_cereals  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand6 "(qVcereals: lnV_cereals  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand7 "(qveg: w_veg  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand8 "(qVveg: lnV_veg  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand9 "(qmilk: w_milk  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand10 "(qVmilk: lnV_milk  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand11 "(qstarches: w_starches  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand12 "(qVstarches: lnV_starches  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand13 "(qcomplements: w_complements  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand14 "(qVcomplements: lnV_complements  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand15 "(qtubers: w_tubers  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand16 "(qVtubers: lnV_tubers  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand17 "(qfruits: w_fruits  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand18 "(qVfruits: lnV_fruits  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand19 "(qfish: w_fish  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"
global demand20 "(qVfish: lnV_fish  ln_tot_exp hsize hh_age i.expensiveregion i.has_electric lpfat lpmeatsproteins  lpcereals lpveg lpmilk lpstarches lpcomplements lptubers lpfruits lpfish )"


*global enlist "ln_tot_exp i.has_electric"
...
reg3 $demand1 $demand2 $demand3 $demand4 $demand5 $demand6 $demand7 $demand8 $demand9 $demand10 $demand11 $demand12 $demand13 $demand14 $demand15 $demand16 $demand17 $demand18 $demand19 $demand20, const(2 4 6 8 10 12 14 16 18 39 41 43 45 47 49 51 53 72 74 76 78 80 82 84 101 103 105 107 109 111 126 128 130 132 134 147 149 151 153 164 166 168 177 179 186) ireg3

* homogeneity removed: 191 192 193 194 195 196 197 198 199 200 201 202 203 204 205 206 207 208 209 210
